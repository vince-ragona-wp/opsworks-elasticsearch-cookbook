...
cookbook 'apt', '>= 2.3.8', git: 'https://github.com/sous-chefs/apt.git', tag: 'v2.3.8'
...
cookbook 'java', '>= 1.19.2', git: 'git://github.com/sous-chefs/java.git', tag: 'v1.29.0'
#cookbook 'java', '>= 1.31.0', git: 'git://github.com/sous-chefs/java.git', tag: 'v1.31.0'
...
#cookbook 'homebrew', '<= 2.1.2', git: 'git://github.com/sous-chefs/homebrew.git', branch: "main"
